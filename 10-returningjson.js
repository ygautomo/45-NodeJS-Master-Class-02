// Filename: 10-returningjson.js
// Course: Pirple Node JS Master Class
// Description: Module 0310 Building RESTful API- Returning JSON
//
// Author: Yugo Gautomo
...
const server = http.createServer(function(req, res){
	...
	req.on('end', function(){
		...
		chosenHandler(data, function(statusCode, payload){
			...
			/* res.end("Hello World! 10-returningjson.js \
...
server.listen(3000, function(){
	console.log("Hello World! 10-returningjson.js \n" + "The server is listening on port 3000 now");
});
...
// Postman POST (http://{{IP_ADDRESS}}:3000/path?month=March&year=2021)			// Postman 10-returningjson
// curl [-X POST/PUT] \
...
// Postman POST (http://{{IP_ADDRESS}}:3000/sample?month=March&year=2021)		// Postman 10-returningjson
// curl [-X POST/PUT] \
